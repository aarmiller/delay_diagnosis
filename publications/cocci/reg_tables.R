...
better_labels <- tribble(~term,~label, 
                         ...
                         "Est ID_consult vs no ID_consult - top2_high_inc_state_baddley", "Infectious Disease consult during visit - Residing in top 2 highest coccidiomycosis incidence state",
                         "Est ID_consult vs no ID_consult - Non-top2_high_inc_state_baddley",  "Infectious Disease consult during visit - Not residing in top 2 highest coccidiomycosis incidence state"
                         )
