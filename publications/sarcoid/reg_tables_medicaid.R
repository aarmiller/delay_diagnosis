...
load(paste0(out_path,"ssd_miss_risk_models_med.RData"))
...
better_labels <- tribble(~term,~label, 
                         ...
                         'raceOther', '  Other',
                         'raceMissing/Unknown', '  Missing/Unknown',
                         'femaleTRUE', 'Female'  , 
...
data <- ssd_miss_risk_models_med$miss_opp_res_med_no_setting
...
write_csv(x = miss_opp_table, file = paste0(table_out_path,"miss_opp_table_medicaid.csv") )
...
data <- ssd_miss_risk_models_med$miss_delay_pat_res
...
data <- ssd_miss_risk_models_med$miss_dur_res_weibull
...
write_csv(x = miss_dur_res, file = paste0(table_out_path,"miss_dur_res_medicaid.csv") )
...
write_csv(x = treatment_res, file = paste0(table_out_path,"treatment_res_medicaid.csv") )
