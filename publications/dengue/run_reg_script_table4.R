...
index_locations <- tm %>% 
  ...
  select(patient_id,setting,weekend,dow, year, month, abx, ID_consult) %>%
  mutate(value = TRUE) %>% 
...
get_miss_res <- function(trial_val){
  ...
  fit <- glm(miss~setting_label + obs_stay + age_cat + female + rural + source + weekend + abx + ID_consult + year + month, 
...
get_miss_res <- function(trial_val){
  ...
  fit <- logistf(miss~setting_label + obs_stay + age_cat + female + rural + source + weekend + abx + ID_consult + year + month,
                           family = "binomial", data=reg_data,
...
get_miss_res <- function(trial_val){
  ...
  test <- glm(miss~setting_label + obs_stay + age_cat + female + rural + source + weekend + abx + ID_consult + year + month,
...
get_miss_res <- function(trial_val){
  ...
  fit <- glm(miss~setting_label + age_cat + female + rural + source + weekend + abx + ID_consult + year + month, 
             family = "binomial", data=reg_data)
...
get_miss_res <- function(trial_val){
  ...
  fit <- logistf(miss~setting_label + age_cat + female + rural + source + weekend + abx + ID_consult + year + month,
                 family = "binomial", data=reg_data,
                 control = logistf.control( maxit = 1000),
                 plcontrol = logistpl.control( maxit = 1000))
...
get_miss_res <- function(trial_val){
  ...
  test <- glm(miss~setting_label + age_cat + female + rural + source + weekend + abx + ID_consult + year + month,
              family = "binomial", data=reg_data, method = "detect_separation")
...
get_miss_res <- function(trial_val){
  ...
  fit <- glm(miss~ inpatient + ed + outpatient + obs_stay + age_cat + female + rural + source + weekend + abx + ID_consult + year + month, 
             family = "binomial", data=reg_data)
...
get_miss_res <- function(trial_val){
  ...
  fit <- logistf(miss~ inpatient + ed + outpatient + obs_stay + age_cat + female + rural + source + weekend + abx + ID_consult + year + month,
                 family = "binomial", data=reg_data,
                 control = logistf.control( maxit = 1000),
                 plcontrol = logistpl.control( maxit = 1000))
...
get_miss_res <- function(trial_val){
  ...
  test <- glm(miss~ inpatient + ed + outpatient + obs_stay + age_cat + female + rural + source + weekend + abx + ID_consult + year + month,
              family = "binomial", data=reg_data, method = "detect_separation")
