---
title: "Fever and Blood Culture Evaluation in Kaiser Sepsis Cohort"
date: "`r Sys.Date()`"
...
```{r}
all_px <- haven::read_sas(paste0("/Shared/AML/kaiser_data/sepsis/sepsis_px_12sep23final.sas7bdat"))
```
