...
rmarkdown::render(input = "/Shared/Statepi_Diagnosis/atlan/github/delay_diagnosis/projects/lung_cancer/risk_model_report_prelim.Rmd",
                  params = list(cond = "Lung Cancer"),
                  output_dir = out_path,
