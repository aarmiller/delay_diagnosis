...
#Script Paths
script_path="/Shared/Statepi_Diagnosis/atlan/github/delay_diagnosis/projects/blasto/explore_LMM_GLMM_models.R"
r_out="/Shared/Statepi_Diagnosis/atlan/out/delay_diagnosis/run_LMM_GLMM_$JOB_ID.txt"
