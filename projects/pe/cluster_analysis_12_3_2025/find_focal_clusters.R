...
load("~/Data/Statepi_Diagnosis/prelim_results/pe/cluster_results/2025_12_04/cluster_res.RData")

load("~/Data/Statepi_Diagnosis/prelim_results/pe/cluster_results/dx_counts.RData")

out_path <- "~/OneDrive - University of Iowa/WorkingPapers/delay_dx_projects/pe/prelim_results/cluster_res_icd_9.csv"
...
chest_pain_10 <- find_focal_clusters(cluster_data = clust_res_10,
                                      focal_code = "R079",
                                      dx_ver = 10L)

chest_pain_9 <- find_focal_clusters(cluster_data = clust_res_9,
                                      focal_code = "78650",
                                      dx_ver = 9L)
...
focal_cluster_res_10 %>% 
  ...
  write_csv("~/OneDrive - University of Iowa/WorkingPapers/delay_dx_projects/pe/prelim_results/cluster_res_icd_10.csv")
...
focal_cluster_res_9 <- bind_rows(mutate(cough_9$condition_counts,term = "cough"),
                                  ...
                                  mutate(chest_pain_9$condition_counts,term = "chest_pain"))
...
focal_cluster_res_9 %>% 
  ...
  mutate(cluster_frac = round(100*total/(3*28),2)) %>% 
  select(code,desc,`Overall Rank`=rank,`Total Clusters`=total,`Cluster Fraction`=cluster_frac) %>% 
  write_csv("~/OneDrive - University of Iowa/WorkingPapers/delay_dx_projects/pe/prelim_results/cluster_res_icd_9.csv")
...
load("~/Data/Statepi_Diagnosis/prelim_results/pe/cluster_results/2025_12_04/cluster_count_data.RData")
...
pdf("~/OneDrive - University of Iowa/WorkingPapers/delay_dx_projects/pe/prelim_results/cluster_plots_icd9.pdf",onefile = TRUE)
...
pdf("~/OneDrive - University of Iowa/WorkingPapers/delay_dx_projects/pe/prelim_results/cluster_plots_icd10.pdf",onefile = TRUE)
...
excluded_codes9 %>% 
  inner_join(filter(codeBuildr::all_icd_labels, dx_ver==9) %>% 
               select(code = dx, desc)) %>% 
  write_csv("~/OneDrive - University of Iowa/WorkingPapers/delay_dx_projects/pe/prelim_results/cluster_res_excluded_icd9.csv")
...
excluded_codes10 %>% 
  inner_join(filter(codeBuildr::all_icd_labels, dx_ver==10) %>% 
               select(code = dx, desc)) %>% 
  write_csv("~/OneDrive - University of Iowa/WorkingPapers/delay_dx_projects/pe/prelim_results/cluster_res_excluded_icd10.csv")

### plot excluded --------------------------------------------------------------


pdf("~/OneDrive - University of Iowa/WorkingPapers/delay_dx_projects/pe/prelim_results/cluster_excluded_plots_icd9.pdf",onefile = TRUE)
...
pdf("~/OneDrive - University of Iowa/WorkingPapers/delay_dx_projects/pe/prelim_results/cluster_excluded_plots_icd10.pdf",onefile = TRUE)
