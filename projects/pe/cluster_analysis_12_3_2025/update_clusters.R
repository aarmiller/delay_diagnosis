...
cluster_out_path <- paste0("~/Data/Statepi_Diagnosis/prelim_results/",cond_name,"/cluster_results/")


# load cluster data
load(paste0("~/Data/Statepi_Diagnosis/prelim_results/",cond_name,"/cluster_results/","/dx_counts.RData"))
...
if(!file.exists(paste0(cluster_out_path,str_replace_all(Sys.Date(),"-","_")))){
  dir.create(paste0(cluster_out_path,str_replace_all(Sys.Date(),"-","_")))
}

save(clust_res_9,clust_res_10,file = paste0(cluster_out_path,str_replace_all(Sys.Date(),"-","_"),"/cluster_res.RData"))
