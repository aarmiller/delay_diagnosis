...
What do the curves look like for the 14,441 (21,075-6,643) patients enrolled for at least 180 days in Kaiser data with an index dx coming from encounter types
AV, ED, IP, or IS that did not meet the selection criteria of >= 80% of visits in [14,0] window with temp reading
