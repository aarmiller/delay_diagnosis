...
sim_out_path <- paste0("/Shared/Statepi_Diagnosis/prelim_results/",cond_name,"/delay_results/any_visit/")
...
other_mods <- mse_res %>%
  anti_join(selected_model, by = c("model_name", "model", "rmse", "label"))
