...
#Script Paths
script_path="github/truven_db_extracts/R/delay_scripts/make_delay_base_data.R"
r_out="/Shared/AML/job_out/R_out/db_extracts/make_delay_base_data_$JOB_ID.txt"
