...
#Description
desc="Run risk factor models for $1"

#Script Paths
script_path="github/truven_db_extracts/R/delay_scripts/run_risk_models.R"
r_out="/Shared/AML/job_out/R_out/db_extracts/run_risk_models_$JOB_ID.txt"
