...
#Description
desc="Get delay results using ssd visit for $1"

#Script Paths
script_path="github/truven_db_extracts/R/delay_scripts/get_delay_res_ssd.R"
r_out="/Shared/AML/job_out/R_out/db_extracts/get_delay_res_ssd_$JOB_ID.txt"
