...
#Description
desc="Run make final delay report for $1"

#Script Paths
script_path="/Shared/Statepi_Diagnosis/atlan/github/delay_diagnosis/build_scripts/R/final_analysis/make_final_delay_report.R"
r_out="/Shared/Statepi_Diagnosis/atlan/out/delay_diagnosis/run_make_final_delay_report_$JOB_ID.txt"
