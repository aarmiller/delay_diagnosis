...
#Description
desc="Run final analyze simulation results $1"

#Script Paths
script_path="/Shared/Statepi_Diagnosis/atlan/github/delay_diagnosis/build_scripts/R/final_analysis/final_analyze_sim_res.R"
r_out="/Shared/Statepi_Diagnosis/atlan/out/delay_diagnosis/run_final_analyze_sim_res_$JOB_ID.txt"
