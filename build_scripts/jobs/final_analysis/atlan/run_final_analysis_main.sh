...
#Description
desc="run_final_analysis_main $1"

#Script Paths
script_path="/Shared/Statepi_Diagnosis/atlan/github/delay_diagnosis/build_scripts/R/final_analysis/run_final_analysis_main.R"
r_out="/Shared/Statepi_Diagnosis/atlan/out/delay_diagnosis/run_final_analysis_main_$JOB_ID.txt"
