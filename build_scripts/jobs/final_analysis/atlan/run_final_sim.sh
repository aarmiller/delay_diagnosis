...
#Description
desc="Run final simulation for $1"

#Script Paths
script_path="/Shared/Statepi_Diagnosis/atlan/github/delay_diagnosis/build_scripts/R/final_analysis/final_sim.R"
r_out="/Shared/Statepi_Diagnosis/atlan/out/delay_diagnosis/run_final_sim_$JOB_ID.txt"
