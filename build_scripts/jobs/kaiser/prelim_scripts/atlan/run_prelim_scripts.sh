...
#Description
desc="run_kaiser_prelim_scripts $1"

#Script Paths
script_path="/Shared/Statepi_Diagnosis/atlan/github/delay_diagnosis/build_scripts/R/kaiser_scripts/run_prelim_scripts.R"
r_out="/Shared/Statepi_Diagnosis/atlan/out/delay_diagnosis/run_kaiser_prelim_scripts_$JOB_ID.txt"
