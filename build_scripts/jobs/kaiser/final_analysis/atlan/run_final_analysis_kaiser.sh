...
#Description
desc="run_kaiser_final_analysis $1"

#Script Paths
script_path="/Shared/Statepi_Diagnosis/atlan/github/delay_diagnosis/build_scripts/R/kaiser_scripts/final_analysis/run_final_analysis_main.R"
r_out="/Shared/Statepi_Diagnosis/atlan/out/delay_diagnosis/run_kaiser_final_analysis_$1.txt"
