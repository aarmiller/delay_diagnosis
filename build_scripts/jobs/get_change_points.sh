...
#Description
desc="Get change points for $1"

#Script Paths
script_path="github/truven_db_extracts/R/delay_scripts/get_change_points.R"
r_out="/Shared/AML/job_out/R_out/db_extracts/get_change_points_$JOB_ID.txt"
