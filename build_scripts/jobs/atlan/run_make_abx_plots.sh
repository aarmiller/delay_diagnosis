...
#Description
desc="run_make_abx_plots"

#Script Paths
script_path="/Shared/Statepi_Diagnosis/atlan/github/delay_diagnosis/build_scripts/R/make_abx_plots.R"
r_out="/Shared/Statepi_Diagnosis/atlan/out/delay_diagnosis/run_make_abx_plots_$JOB_ID.txt"
